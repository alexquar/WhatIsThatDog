...
const UploadPage = () => {
  ...
  const submitImage = () => {
    ...
    Alert.alert('Processing', 'Your image is being sent to the server for analysis.');
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.introSection}>
        <Text style={styles.body}>
          Take a photo or upload an image of the dog you want to identify. Our app will process it
          and provide you with detailed breed information.
        </Text>
      </View>
